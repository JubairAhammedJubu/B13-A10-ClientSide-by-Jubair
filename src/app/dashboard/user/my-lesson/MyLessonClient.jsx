      ...
      <motion.div className="relative z-10 w-full max-w-lg bg-white dark:bg-[#1a1d24] rounded-2xl p-6">
        ...
        <div className="grid grid-cols-2 gap-3 mb-3">
          <select
            ...
            onChange={handleChange}
            className="w-full appearance-none pl-3 pr-8 py-2 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-sm text-gray-900 dark:text-gray-100 transition-all"
          >
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="w-full overflow-x-auto bg-white dark:bg-[#1a1d24] rounded-2xl border">
              ...
              {lessons.length === 0 ? (
                ...
                lessons.map((lesson) => (
                  <tr key={lesson._id} className="border-b">
                    ...
                    <td className="text-right p-3 flex gap-6 justify-end">
