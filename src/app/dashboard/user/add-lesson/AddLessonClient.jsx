        ...
        <div>
            ...
            <div className="mb-3 flex flex-col items-center gap-2">
              <div className="relative w-full rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700">
                ...
                <button
                  ...
                  className="absolute top-2 right-2 w-7 h-7 rounded-lg bg-black/50 flex items-center justify-center text-white hover:bg-black/70"
                >
              ...
              {!form.image ? (
                <div className="flex items-center gap-2 w-full">
                  <span className="text-xs text-amber-500 bg-amber-50 dark:bg-amber-900/20 px-2 py-1 rounded-lg flex-1 text-center">
                ...
                <span className="text-xs text-emerald-600 bg-emerald-50 dark:bg-emerald-900/20 px-2 py-1 rounded-lg w-full text-center">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full py-2 rounded-xl border border-emerald-200 dark:border-emerald-800 text-emerald-600 text-sm font-medium"
            >
              Preview Image
            </button>
          </div>
